  ...
  return (
    <div className="container mx-auto max-w-3xl py-8">
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-semibold tracking-tight">Project Setup</h2>
        <p className="mt-3 text-base text-gray-600">
          Use this checklist to ensure all of your integrations have been set up
        </p>
            ...
            <div>
              ...
              <ol className="mt-4 space-y-2 text-sm text-green-700 list-decimal pl-5">
                <li>
                  ...
                  directory to remove this setup page
                </li>
              </ol>
            </div>
          </div>
      ...
      <div className="space-y-8">
        ...
        <section className="rounded-lg border border-gray-100 overflow-hidden shadow-sm">
          <div className="flex items-center px-4 py-3">
            <div className="flex h-10 w-10 overflow-hidden items-center justify-center rounded-full bg-gray-200 mr-4">
              <img
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Database and authentication with NeonAuth
              </p>
            </div>
          </div>
        ...
        <section className="rounded-lg border border-gray-100 overflow-hidden shadow-sm">
          <div className="flex items-center px-4 py-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 mr-4">
              <Server className="h-5 w-5 text-gray-800" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-800">
                Database Tables
              ...
              <p className="text-sm text-gray-600">
                Required database tables and their status
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p
                    className={`font-medium ${
                      !process.env.NEXT_PUBLIC_VERCEL_URL ? 'text-gray-500' : ''
                    }`}
                  >
        ...
        <section className="rounded-lg border border-gray-100 overflow-hidden shadow-sm">
          <div className="flex items-center px-4 py-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">QStash</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p
                    className={`font-medium ${
                      !process.env.STRIPE_WEBHOOK_SECRET ? 'text-gray-500' : ''
                    }`}
                  >
